...
public class UpcomingFragment extends Fragment {
    ...
    private void loadJSON(){
        ...
        Call<JSONResponse> call = request.getJSON("upcoming", BuildConfig.API_KEY,1);
    ...
    private class MovieLoadTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected Cursor doInBackground(Void... voids) {
            return mMoviesDbHelper.getAll(3);
        }
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while(cursor.moveToNext()) {
                    ...
                    Movie data = new Movie(id, title,overview,original_title,vote_count,vote_average,popularity,languaje,image,image_poster,release,homepage,3);
                    list.add(data);
                }

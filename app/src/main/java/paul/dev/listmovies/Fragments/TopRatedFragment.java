...
public class TopRatedFragment extends Fragment {
    ...
    private void loadJSON(){
        ...
        Call<JSONResponse> call = request.getJSON("top_rated", BuildConfig.API_KEY,1);
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                for (int i = 0; i < jsonResponse.getAndroid().length; i++) {
                    ...
                    Log.d("Paulo", jsonResponse.getAndroid()[i].gettitle());
    ...
    private class MovieLoadTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected Cursor doInBackground(Void... voids) {
            return mMoviesDbHelper.getAll(2);
        }
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while(cursor.moveToNext()) {
                    ...
                    Movie data = new Movie(id, title,overview,original_title,vote_count,vote_average,popularity,languaje,image,image_poster,release,homepage,2);
                    list.add(data);
                }
